...
public class ExampleParser extends Parser {
	...
	public static class SContext extends ParserRuleContext {
		public TerminalNode TYPE() { return getToken(ExampleParser.TYPE, 0); }
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ExampleListener ) ((ExampleListener)listener).enterS(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ExampleListener ) ((ExampleListener)listener).exitS(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ExampleVisitor ) return ((ExampleVisitor<? extends T>)visitor).visitS(this);
